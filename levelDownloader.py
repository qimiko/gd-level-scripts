...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        description="Downloads GD Levels",
        epilog="Daily ID: -1, Weekly ID: -2")
    ...
    parser.add_argument(
        '--gameversion',
        '-gv',
        help='Game Version (defaults to 22, int)',
        type=int,
        default=22)

    parser.add_argument(
        '--url',
        help='Site URL (defaults to www.boomlings.com)',
        default='http://www.boomlings.com/database/downloadGJLevel21.php')

    parser.add_argument(
        '--secret',
        '-s',
        help='Secret (Don\'t set this unless you know what you\'re doing!, \
              autoset)',
        default='Wmfd2893gb7')
